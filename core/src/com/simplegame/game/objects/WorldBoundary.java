...
//
//    public WorldBoundary(float WORLD_WIDTH, float WORLD_HEIGHT) {
//        bottom = Own.box2d.factory.getEdgeBody(BodyDef.BodyType.StaticBody, new Vector2(0, 1), 0, 0, 0, WORLD_WIDTH, 0, 0.5f, 1.0f, 0.5f, "bottom");
...
//        switch (type) {
//            case WorldBoundary.LEFT:
//                left.setTransform(point, angle);
//                break;
//            case WorldBoundary.RIGHT:
//                right.setTransform(point, angle);
//                break;
//            case WorldBoundary.TOP:
//                top.setTransform(point, angle);
//                break;
//            case WorldBoundary.BOTTOM:
