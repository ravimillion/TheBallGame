...
public class BodyEditorLoader {
    ...
    public void attachFixture(Body body, String name, FixtureDef fd, float scale) {
        ...
        float[] s = {scale, scale, scale, scale, scale, scale, scale, scale, scale};
...
//				OrderedMap<String,?> vertexElem = (OrderedMap<String,?>) verticesElem.get(ii);
                JsonValue vertextElem = verticesElem.get(ii);
                float x = vertextElem.getFloat("x");
                float y = vertextElem.getFloat("y");
